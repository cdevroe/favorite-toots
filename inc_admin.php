...
function cdevroe_tootfaves_display_instance_url() {
    ?>
    <input type="text" placeholder="social.lol" name="cdevroe_tootfaves_instance_url" id="cdevroe_tootfaves_instance_url" value="<?php echo esc_attr( get_option('cdevroe_tootfaves_instance_url') ); ?>" /><br />
    <small>do not include https://</small>
    <?php
}
